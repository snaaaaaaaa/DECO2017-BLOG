...
summary: Site structure, Wireframes, & Modular Design
tags:
  - Sitemap 
  - Wireframes
---
After concluding our discovery phase and consolidating our design insights, we narrowed down the pages we want to include in our web app. We decided on:

- A home page featuring a trending recipes section
- A user profile page unique to the signed-in user, where they can create recipes (this is the stand-out feature)
- A browse recipes page with a thorough filtering system where users can save recipes
- A user-created communities page
- A dedicated page for each individual recipe with options for users to add comments and post adaptations to recipes.

With these pages in mind I sketched out a site map marking the key pages and possible user interactions. 

![Sitemap Sketch](posts/images/sitemap.jpg) 
...
With this said, there is not yet a structured or set format for how the website data will be collected and used for the prototype, hence these prioritised features and the proposed site structure may change. We have decided on the variety and the quantity of recipes we would like to include, however the exact format of the data will be decided after next week’s tutorial which covers designing data with modelling tools. 
...
![Wireframes](posts/images/wireframes.png)
